...
<body>
	...
	<div id="contenedor">
		...
		<div class="row">
			<div class="col-xs-12 col-md-10 push-md-1" id="busqueda">
				<form action="">
					
					<div class="form-group col-xs-12 col-md-6">
						<label class="col-md-4" for="select">Producto</label>
						<div class="col-md-8">
							<select name="productoBuscar" class="form-control selectpicker" id="campoTipo">
					...
					<div class="form-group col-xs-12 col-md-6 campoBusqueda" id="divProvBuscar">
						<label class="col-md-4" for="select">Provincia</label>
						<div class="col-md-8">
							<select name="provincia" class="form-control selectpicker" id="campoProvincia">
					...
					<div class="form-group col-xs-12 col-md-6 campoBusqueda" id="divOrdenBuscar">
						<label class="col-md-4" for="select">Ordenar por</label>
						<div class="col-md-8">
							<select name="orden" class="form-control selectpicker" id="campoOrden">
								<option value="" disabled selected hidden class="col-xs-12">Selecciona el orden</option>
								<option value="nombreascendente" class="col-xs-12">Nombre ascendente A↓</option>
								<option value="nombredescendente" class="col-xs-12">Nombre descendente Z↑</option>
								<option value="masreciente" class="col-xs-12">Mas reciente</option>
								<option value="menosreciente" class="col-xs-12">Menos reciente</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group col-xs-12 col-md-6 campoSubida" id="categoriaLibro">
						...
						<div class="col-md-8">
							<select name="categoriaLibro" class="form-control selectpicker" id="campoCategoriaLibro">
					...
					<div class="form-group col-xs-12 col-md-6 campoSubida" id="categoriaPelicula">
						<label class="col-md-4" for="select">Categoria</label>
						<div class="col-md-8">
							<select name="categoriaPelicula" class="form-control selectpicker" id="campoCategoriaPelicula">
								<option value="" disabled selected hidden class="col-xs-12">Selecciona la categoria</option>
					...
					<div class="form-group col-xs-12 col-md-6 campoSubida" id="categoriaVideojuego">
						<label class="col-md-4" for="select">Categoria</label>
						<div class="col-md-8">
							<select name="categoriaVideojuego" class="form-control selectpicker" id="campoCategoriaVideojuego">
								<option value="" disabled selected hidden class="col-xs-12">Selecciona la categoria</option>
								<option value="Accion" class="col-xs-12">Accion</option>
								<option value="Aventura" class="col-xs-12">Aventura</option>
					...
					<div class="form-group col-xs-12 col-md-6 campoSubida" id="consola">
						...
						<div class="col-md-8">
							<select name="consola" class="form-control selectpicker" id="campoConsola">
					...
					<div class="form-group col-xs-12 col-md-6 campoSubida" id="formato">
						...
						<div class="col-md-8">
							<select name="formato" class="form-control selectpicker" id="campoFormato">
					...
					<div class="form-group col-xs-12 col-md-6 campoBusqueda" id="divNombreBuscar">
						<label class="col-md-4" for="nombre">Nombre</label>
						<div class="col-md-8">
							<input name="nombre" type="text" placeholder="Nombre" class="form-control input-md" id="campoNombre">
						</div>
					</div>

					<div class="col-xs-12"></div>

					<div class="col-xs-6 push-xs-3 col-md-4 push-md-4 form-group">
						<input type="Button" id="reset" value="Quitar filtros" class="form-control btn btn-warning">
					</div>

					<div class="col-xs-12" id="espacioEnviar"></div>
				</form>
		
			<div class="col-xs-12" id="resultadoFiltro">
				<!-- CARGADO DINAMICO DE LOS RESULTADOS -->
			</div>
