...
<%
	...
	request.getSession();
	/*Obtenemos el tipo de articulo y los datos*/
...
<body>
	<div id="contenedor">
		...
		<!-- CUERPO -->
		<div class="row">
			<div class="col-xs-12 col-md-10 push-md-1" id="cuerpoArticulo">
				<div class="col-xs-12 col-md-10 push-md-1 marco">
					<div class='col-xs-12 infoProducto'>
